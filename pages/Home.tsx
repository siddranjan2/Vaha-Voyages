  ...
  return (
    <div className="bg-white">
      ...
      <section className="relative h-[95vh] w-full flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 w-full max-w-6xl animate-fade-in">
          <span className="inline-block bg-teal-600 text-white px-6 py-2 rounded-full text-xs font-bold uppercase tracking-[0.2em] mb-8 shadow-2xl">
            Adventure Awaits
          </span>
          ...
          <p className="text-xl md:text-2xl text-white/90 font-medium mb-12 tracking-wide max-w-2xl mx-auto drop-shadow-md">
          ...
          <div className="bg-white/10 backdrop-blur-2xl p-2 rounded-3xl md:rounded-full border border-white/20 flex flex-col md:flex-row items-stretch w-full max-w-6xl mx-auto shadow-2xl">
            ...
            {/* Destination Field */}
            <div className="flex-grow flex items-center px-6 py-4 group hover:bg-white/5 transition-all rounded-2xl md:rounded-l-full">
            ...
            <div className="flex-grow flex items-center px-6 py-4 group hover:bg-white/5 transition-all">
            ...
            <button 
              ...
              className="bg-teal-500 text-slate-900 font-black uppercase tracking-[0.2em] px-10 py-5 rounded-2xl md:rounded-full hover:bg-white hover:scale-[1.03] transition-all active:scale-95 whitespace-nowrap shadow-xl m-1 text-sm"
            >
              Search
            </button>
          </div>
        ...
        <div className="container mx-auto">
          <div className="flex justify-between items-end mb-20">
            <div>
              ...
              <h2 className="text-5xl md:text-6xl font-serif text-slate-900">Signature Trips</h2>
            </div>
          ...
          <div className="flex overflow-x-auto gap-10 pb-12 no-scrollbar scroll-smooth snap-x">
            {trips.filter(t => t.featured).map((trip) => (
              <Link 
                key={trip.id} 
                to={`/trip/${trip.id}`} 
                className="group flex-shrink-0 w-[320px] md:w-[480px] relative h-[650px] overflow-hidden rounded-[3rem] bg-slate-200 snap-center shadow-xl"
              >
                <RobustImage 
                  src={trip.mainImage} 
                  alt={trip.title} 
                ...
                <div className="absolute bottom-0 left-0 p-12 w-full">
                  ...
                  <h3 className="text-3xl font-serif text-white mb-2 leading-tight">{trip.title}</h3>
                  <p className="text-white/70 text-sm mb-6 uppercase tracking-widest font-medium">
                    {trip.destination}, {trip.country}
                  </p>
                  <div className="flex justify-between items-center border-t border-white/20 pt-6">
                    <span className="text-white/90 text-sm font-bold tracking-widest">{trip.duration}</span>
                    <span className="text-white font-serif text-2xl">₹ {trip.basePrice.toLocaleString()}</span>
                  </div>
                </div>
              </Link>
            ))}
      ...
      <section className="py-32 bg-white relative overflow-hidden">
        <div className="container mx-auto px-6 flex flex-col md:flex-row items-center gap-24">
           <div className="md:w-1/2 relative">
             <div className="absolute inset-0 border-[12px] border-teal-600/5 -m-8 rounded-[4rem]"></div>
             <div className="bg-slate-100 rounded-[3rem] overflow-hidden h-[600px] shadow-2xl relative z-10">
               <RobustImage 
           ...
           <div className="md:w-1/2 space-y-8">
              ...
              <h2 className="text-5xl md:text-7xl font-serif leading-tight text-slate-900">Bespoke Journeys.</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10 pt-6">
                <div className="group">
                  ...
                  <p className="text-sm uppercase tracking-widest font-black text-slate-900 mb-2">Tailored Routes</p>
                  <p className="text-xs text-slate-400 font-medium leading-relaxed">Every turn mapped to your unique rhythm and curiosity.</p>
                </div>
                <div className="group">
                   <div className="w-12 h-12 bg-sky-50 rounded-2xl flex items-center justify-center text-sky-500 mb-6 group-hover:bg-sky-500 group-hover:text-white transition-all">
                  ...
                  <p className="text-sm uppercase tracking-widest font-black text-slate-900 mb-2">Private Crew</p>
                  <p className="text-xs text-slate-400 font-medium leading-relaxed">Dedicated experts at your command, from peak to base.</p>
                </div>
              </div>
              <div className="pt-8">
                <Link to="/destinations" className="inline-block bg-slate-900 text-white px-12 py-5 rounded-full text-xs font-black uppercase tracking-widest shadow-xl hover:bg-teal-600 transition-all">
                  Design Your Route
                </Link>
              </div>
           </div>
